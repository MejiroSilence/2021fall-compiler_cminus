...
; ModuleID = 'while_hand.c'
source_filename = "while_hand.c"
...
define dso_local i32 @main() #0 {
    ...
    br label %loop
; actually I change the code to a do-while loop,
; because we know i is 0 when loop start
