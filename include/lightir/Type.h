...
class StructType : public Type // TODO:
{
public:
    StructType(Module *m, std::vector<Type *> contained_, std::string name_) : Type(StructTyID, m), contained(contained_), name(name_) {}
    static StructType *get(Module *m);
